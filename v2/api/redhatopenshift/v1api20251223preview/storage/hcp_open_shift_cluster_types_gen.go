...
// - Generated from: /redhatopenshift/resource-manager/Microsoft.RedHatOpenShift/hcpopenshiftclusters/preview/2025-12-23-preview/openapi.json
...
func (cluster *HcpOpenShiftCluster) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected redhatopenshift/v1api20260630preview/storage/HcpOpenShiftCluster but received %T instead", hub)
	}
...
func (properties *HcpOpenShiftClusterProperties) AssignProperties_From_HcpOpenShiftClusterProperties(source *storage.HcpOpenShiftClusterProperties) error {
	...
	if source.Ingress != nil {
		propertyBag.Add("Ingress", *source.Ingress)
	} else {
		propertyBag.Remove("Ingress")
	}
...
func (properties *HcpOpenShiftClusterProperties) AssignProperties_To_HcpOpenShiftClusterProperties(destination *storage.HcpOpenShiftClusterProperties) error {
	...
	// Ingress
	if propertyBag.Contains("Ingress") {
		var ingress storage.IngressProfile
		err := propertyBag.Pull("Ingress", &ingress)
		if err != nil {
			return eris.Wrap(err, "pulling 'Ingress' from propertyBag")
		}
...
func (mirror *ImageDigestMirror) AssignProperties_From_ImageDigestMirror(source *storage.ImageDigestMirror) error {
	...
	// Mirrors
	mirror.Mirrors = genruntime.CloneSliceOfString(source.Mirrors)

	// Source
	mirror.Source = genruntime.ClonePointerToString(source.Source)

	// Update the property bag
	if len(propertyBag) > 0 {
		mirror.PropertyBag = propertyBag
	} else {
		mirror.PropertyBag = nil
	}

	// Invoke the augmentConversionForImageDigestMirror interface (if implemented) to customize the conversion
	var mirrorAsAny any = mirror
	if augmentedMirror, ok := mirrorAsAny.(augmentConversionForImageDigestMirror); ok {
		err := augmentedMirror.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
	}
...
func (mirror *ImageDigestMirror) AssignProperties_To_ImageDigestMirror(destination *storage.ImageDigestMirror) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(mirror.PropertyBag)

	// Mirrors
	destination.Mirrors = genruntime.CloneSliceOfString(mirror.Mirrors)

	// Source
	destination.Source = genruntime.ClonePointerToString(mirror.Source)
	...
	var mirrorAsAny any = mirror
	if augmentedMirror, ok := mirrorAsAny.(augmentConversionForImageDigestMirror); ok {
		err := augmentedMirror.AssignPropertiesTo(destination)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesTo() for conversion")
		}
	}
...
func (mirror *ImageDigestMirror_STATUS) AssignProperties_From_ImageDigestMirror_STATUS(source *storage.ImageDigestMirror_STATUS) error {
	...
	// Invoke the augmentConversionForImageDigestMirror_STATUS interface (if implemented) to customize the conversion
	var mirrorAsAny any = mirror
	if augmentedMirror, ok := mirrorAsAny.(augmentConversionForImageDigestMirror_STATUS); ok {
		err := augmentedMirror.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type augmentConversionForImageDigestMirror interface {
	AssignPropertiesFrom(src *storage.ImageDigestMirror) error
	AssignPropertiesTo(dst *storage.ImageDigestMirror) error
}

type augmentConversionForImageDigestMirror_STATUS interface {
	AssignPropertiesFrom(src *storage.ImageDigestMirror_STATUS) error
	AssignPropertiesTo(dst *storage.ImageDigestMirror_STATUS) error
}
