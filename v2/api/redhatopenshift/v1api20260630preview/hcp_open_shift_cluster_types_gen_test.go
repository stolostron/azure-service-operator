...
func AddIndependentPropertyGeneratorsForCondition_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(ConditionType_STATUS_Available, ConditionType_STATUS_Degraded, ConditionType_STATUS_Progressing))
}
...
func AddRelatedPropertyGeneratorsForHcpOpenShiftClusterProperties(gens map[string]gopter.Gen) {
	...
	gens["Ingress"] = gen.PtrOf(IngressProfileGenerator())
...
func AddIndependentPropertyGeneratorsForIngressProfile(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(IngressProfile_Type_Disabled, IngressProfile_Type_Private, IngressProfile_Type_Public))
}
...
func AddIndependentPropertyGeneratorsForIngressProfile_STATUS(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(IngressProfile_Type_STATUS_Disabled, IngressProfile_Type_STATUS_Private, IngressProfile_Type_STATUS_Public))
}
...
func Test_ResourceStatus_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ResourceStatus_STATUS to ResourceStatus_STATUS via AssignProperties_To_ResourceStatus_STATUS & AssignProperties_From_ResourceStatus_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForResourceStatus_STATUS, ResourceStatus_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForResourceStatus_STATUS tests if a specific instance of ResourceStatus_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForResourceStatus_STATUS(subject ResourceStatus_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()
...
func Test_ResourceStatus_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ResourceStatus_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForResourceStatus_STATUS, ResourceStatus_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}
...
func RunJSONSerializationTestForResourceStatus_STATUS(subject ResourceStatus_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
var resourceStatus_STATUSGenerator gopter.Gen

// ResourceStatus_STATUSGenerator returns a generator of ResourceStatus_STATUS instances for property testing.
func ResourceStatus_STATUSGenerator() gopter.Gen {
	if resourceStatus_STATUSGenerator != nil {
		return resourceStatus_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForResourceStatus_STATUS(generators)
	resourceStatus_STATUSGenerator = gen.Struct(reflect.TypeOf(ResourceStatus_STATUS{}), generators)

	return resourceStatus_STATUSGenerator
}

// AddRelatedPropertyGeneratorsForResourceStatus_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForResourceStatus_STATUS(gens map[string]gopter.Gen) {
	gens["Conditions"] = gen.SliceOf(Condition_STATUSGenerator())
}
